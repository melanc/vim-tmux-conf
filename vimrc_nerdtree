...
autocmd vimenter * if has('gui_running') | NERDTree | endif
autocmd bufenter * if (winnr("$") == 1 && exists("b:NERDTree") && b:NERDTree.isTabTree()) | q | endif
nmap <silent><F7> <Esc>:NERDTreeToggle<CR>
...
" 更改工作目录
exec("lcd ~/workspace")
au BufNewFile,BufReadPost * exec("lcd ".expand('%:h'))
